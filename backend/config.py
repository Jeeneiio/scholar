...
class Config:
    ...
    MILVUS_URI = os.getenv("MILVUS_LITE_URI") or os.getenv("MILVUS_URI", "./data/milvus.db")
    ...
    # SQLite keeps file/session metadata on the local server without Docker.
    SQLITE_PATH = os.getenv("SQLITE_PATH", "./db/scholar_rag.sqlite3")
