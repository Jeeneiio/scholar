...
class MilvusStoreFactory:
    ...
    def create_store(
        ...
        # Milvus Lite does not support the server-side FunctionScore hybrid
        # reranker. Use a dense-only collection locally; Milvus Standalone
        # keeps the full BM25 + dense hybrid configuration below.
